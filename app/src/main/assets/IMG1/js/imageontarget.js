var World = {
    ...
    createOverlays: function createOverlaysFn() {
        ...
        */
        ...
        /*Tanda "*" I guess "pageOne" means load target with the name "pageOne" form the target collection. "*" seems to act like a wildcard to load all targets from this collection*/
        ...
        this.RA = new AR.ImageTrackable(this.tracker, "RA", {
            drawables: {
                cam: overlayTwo
            },
            onImageRecognized: World.hideInfoBar,
